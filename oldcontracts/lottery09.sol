...
contract Lottery is VRFConsumerBase, Ownable, Pausable {
    ...
    modifier whenNotFull(uint256 numEntries) {
        require(nextUserId + numEntries <= maxEntries, "Maximum entries reached");
        _;
    }
    ...
    function enterLottery(uint256 numEntries) external whenNotPaused whenNotFull(numEntries){
